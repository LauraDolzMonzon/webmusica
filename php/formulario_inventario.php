                ...
                <tr>
                    ...
                    <td>
                        ...
                        <select name="invetariofamilia" id="invetariofamilia" required>
                            <option value="sinespecificarfamilia2">Sinespecificarfamilia</soption>
                    ...
                    <td><input type="date" id="invetarioanodeadquision" name="invetarioanodeadquision" pattern="^[0-9]{4}$" maxlength="4" minlength="4" required> </td>
